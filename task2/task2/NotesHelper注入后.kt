...
class NotesHelper(val context: Context) {
    ...
    fun exportNotes(notesToBackup: List<Note>, outputStream: OutputStream): ExportResult {
        return try {
            val backupReviewContext = BACKUP_REVIEW_CONTEXT
